...
func TestConfigReloadBoolFlags(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// Logtime
		{
			name:     "logtime_not_in_config_no_override",
			content:  "",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Logtime },
		},
		{
			name:     "logtime_not_in_config_override_short_true",
			content:  "",
			cmdLine:  []string{"-T"},
			expected: true,
			val:      func() bool { return opts.Logtime },
		...
		{
			name:     "logtime_not_in_config_override_true",
			content:  "",
			cmdLine:  []string{"-logtime"},
			expected: true,
			val:      func() bool { return opts.Logtime },
		},
		{
			name:     "logtime_false_in_config_no_override",
			content:  "logtime: false",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Logtime },
		},
		{
			name:     "logtime_false_in_config_override_short_true",
			content:  "logtime: false",
			cmdLine:  []string{"-T"},
			expected: true,
			val:      func() bool { return opts.Logtime },
		...
		{
			name:     "logtime_false_in_config_override_true",
			content:  "logtime: false",
			cmdLine:  []string{"-logtime"},
			expected: true,
			val:      func() bool { return opts.Logtime },
		...
		{
			name:     "logtime_true_in_config_no_override",
			content:  "logtime: true",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Logtime },
		},
		{
			name:     "logtime_true_in_config_override_short_false",
			content:  "logtime: true",
			cmdLine:  []string{"-T=false"},
			expected: false,
			val:      func() bool { return opts.Logtime },
		},
		{
			name:     "logtime_true_in_config_override_false",
			content:  "logtime: true",
			cmdLine:  []string{"-logtime=false"},
			expected: false,
			val:      func() bool { return opts.Logtime },
		},
		// Debug
		{
			name:     "debug_not_in_config_no_override",
			content:  "",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Debug },
		},
		{
			name:     "debug_not_in_config_override_short_true",
			content:  "",
			cmdLine:  []string{"-D"},
			expected: true,
			val:      func() bool { return opts.Debug },
		...
		{
			name:     "debug_not_in_config_override_true",
			content:  "",
		...
		{
			name:     "debug_false_in_config_no_override",
			content:  "debug: false",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Debug },
		...
		{
			name:     "debug_false_in_config_override_short_true",
			content:  "debug: false",
			cmdLine:  []string{"-D"},
			expected: true,
			val:      func() bool { return opts.Debug },
		...
		{
			name:     "debug_false_in_config_override_true",
			content:  "debug: false",
			cmdLine:  []string{"-debug"},
			expected: true,
			val:      func() bool { return opts.Debug },
		...
		{
			name:     "debug_true_in_config_no_override",
			content:  "debug: true",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Debug },
		...
		{
			name:     "debug_true_in_config_override_short_false",
			content:  "debug: true",
			cmdLine:  []string{"-D=false"},
			expected: false,
			val:      func() bool { return opts.Debug },
		},
		{
			name:     "debug_true_in_config_override_false",
			content:  "debug: true",
			cmdLine:  []string{"-debug=false"},
			expected: false,
			val:      func() bool { return opts.Debug },
		},
		// Trace
		{
			name:     "trace_not_in_config_no_override",
			content:  "",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Trace },
		},
		{
			name:     "trace_not_in_config_override_short_true",
			content:  "",
			cmdLine:  []string{"-V"},
			expected: true,
			val:      func() bool { return opts.Trace },
		...
		{
			name:     "trace_not_in_config_override_true",
			content:  "",
			cmdLine:  []string{"-trace"},
			expected: true,
			val:      func() bool { return opts.Trace },
		},
		{
			name:     "trace_false_in_config_no_override",
			content:  "trace: false",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Trace },
		...
		{
			name:     "trace_false_in_config_override_short_true",
			content:  "trace: false",
			cmdLine:  []string{"-V"},
			expected: true,
			val:      func() bool { return opts.Trace },
		...
		{
			name:     "trace_false_in_config_override_true",
			content:  "trace: false",
			cmdLine:  []string{"-trace"},
			expected: true,
			val:      func() bool { return opts.Trace },
		...
		{
			name:     "trace_true_in_config_no_override",
			content:  "trace: true",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Trace },
		...
		{
			name:     "trace_true_in_config_override_short_false",
			content:  "trace: true",
			cmdLine:  []string{"-V=false"},
			expected: false,
			val:      func() bool { return opts.Trace },
		},
		{
			name:     "trace_true_in_config_override_false",
			content:  "trace: true",
			cmdLine:  []string{"-trace=false"},
			expected: false,
			val:      func() bool { return opts.Trace },
		},
		// Syslog
		{
			name:     "syslog_not_in_config_no_override",
			content:  "",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Syslog },
		},
		{
			name:     "syslog_not_in_config_override_short_true",
			content:  "",
			cmdLine:  []string{"-s"},
			expected: true,
			val:      func() bool { return opts.Syslog },
		...
		{
			name:     "syslog_not_in_config_override_true",
			content:  "",
			cmdLine:  []string{"-syslog"},
			expected: true,
			val:      func() bool { return opts.Syslog },
		},
		{
			name:     "syslog_false_in_config_no_override",
			content:  "syslog: false",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Syslog },
		},
		{
			name:     "syslog_false_in_config_override_short_true",
			content:  "syslog: false",
			cmdLine:  []string{"-s"},
			expected: true,
			val:      func() bool { return opts.Syslog },
		...
		{
			name:     "syslog_false_in_config_override_true",
			content:  "syslog: false",
			cmdLine:  []string{"-syslog"},
			expected: true,
			val:      func() bool { return opts.Syslog },
		...
		{
			name:     "syslog_true_in_config_no_override",
			content:  "syslog: true",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Syslog },
		...
		{
			name:     "syslog_true_in_config_override_short_false",
			content:  "syslog: true",
			cmdLine:  []string{"-s=false"},
			expected: false,
			val:      func() bool { return opts.Syslog },
		},
		{
			name:     "syslog_true_in_config_override_false",
			content:  "syslog: true",
			cmdLine:  []string{"-syslog=false"},
			expected: false,
			val:      func() bool { return opts.Syslog },
		},
		// Cluster.NoAdvertise
		{
			name: "cluster_no_advertise_not_in_config_no_override",
			content: `cluster {
				port: -1
			}`,
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.Cluster.NoAdvertise },
		},
		{
			name: "cluster_no_advertise_not_in_config_override_true",
			content: `cluster {
				port: -1
			}`,
			cmdLine:  []string{"-no_advertise"},
			expected: true,
			val:      func() bool { return opts.Cluster.NoAdvertise },
		},
		{
			name: "cluster_no_advertise_false_in_config_no_override",
			content: `cluster {
				port: -1
				no_advertise: false
			}`,
		...
		{
			name: "cluster_no_advertise_false_in_config_override_true",
			content: `cluster {
				port: -1
				no_advertise: false
			}`,
		...
		{
			name: "cluster_no_advertise_true_in_config_no_override",
			content: `cluster {
				port: -1
				no_advertise: true
			}`,
		...
		{
			name: "cluster_no_advertise_true_in_config_override_false",
			content: `cluster {
				port: -1
				no_advertise: true
			}`,
			cmdLine:  []string{"-no_advertise=false"},
			expected: false,
			val:      func() bool { return opts.Syslog },
		},
		// -DV override
		{
			name:     "debug_trace_not_in_config_dv_override_true",
			content:  "",
			cmdLine:  []string{"-DV"},
			expected: true,
			val:      func() bool { return opts.Debug && opts.Trace },
		},
		{
			name: "debug_trace_false_in_config_dv_override_true",
			content: `debug: false
		     trace: false
			`,
			cmdLine:  []string{"-DV"},
		...
		{
			name: "debug_trace_true_in_config_dv_override_false",
			content: `debug: true
		     trace: true
			`,
			cmdLine:  []string{"-DV=false"},
			expected: false,
			val:      func() bool { return opts.Debug && opts.Trace },
		},
		{
			name: "trace_verbose_true_in_config_override_true",
			content: `trace_verbose: true
			`,
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.Trace && opts.TraceVerbose },
		},
		{
			name: "trace_verbose_true_in_config_override_false",
			content: `trace_verbose: true
			`,
			cmdLine:  []string{"--VV=false"},
			expected: true,
			val:      func() bool { return !opts.TraceVerbose },
		},
		{
			name: "trace_verbose_true_in_config_override_false",
			content: `trace_verbose: false
			`,
			cmdLine:  []string{"--VV=true"},
			expected: true,
			val:      func() bool { return opts.TraceVerbose },
		},
		// --js override
		{
			name:     "jetstream_not_in_config_no_override",
			content:  "",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.JetStream },
		},
		{
			name:     "jetstream_not_in_config_override_true",
			content:  "",
			cmdLine:  []string{"--js"},
			expected: true,
			val:      func() bool { return opts.JetStream },
		...
		{
			name:     "jetstream_false_in_config_no_override",
			content:  "jetstream: false",
			cmdLine:  nil,
			expected: false,
			val:      func() bool { return opts.JetStream },
		},
		{
			name:     "jetstream_false_in_config_override_true",
			content:  "jetstream: false",
			cmdLine:  []string{"--js"},
			expected: true,
			val:      func() bool { return opts.JetStream },
		...
		{
			name:     "jetstream_true_in_config_no_override",
			content:  "jetstream: true",
			cmdLine:  nil,
			expected: true,
			val:      func() bool { return opts.JetStream },
		},
		{
			name:     "jetstream_true_in_config_override_false",
			content:  "jetstream: true",
			cmdLine:  []string{"--js=false"},
			expected: false,
			val:      func() bool { return opts.JetStream },
		},
	} {
...
func TestConfigReloadRouteImportPermissionsWithAccounts(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "regular", poolSize: "pool_size: -1", accounts: _EMPTY_},
		{name: "pooling", poolSize: "pool_size: 5", accounts: _EMPTY_},
		{name: "per-account", poolSize: _EMPTY_, accounts: "accounts: [\"A\"]"},
		{name: "pool and per-account", poolSize: "pool_size: 3", accounts: "accounts: [\"A\"]"},
	} {
