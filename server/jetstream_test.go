...
func TestJetStreamAtomicPublish(t *testing.T) {
	test := func(
		t *testing.T,
		nc *nats.Conn,
...
func TestJetStreamAtomicPublishDedupe(t *testing.T) {
	test := func(
		t *testing.T,
		nc *nats.Conn,
		js nats.JetStreamContext,
		...
		// TODO(mvv): accept part of the batch and exclude duplicates, instead of fully rejecting
		require_Error(t, pubAck.Error, NewJSAtomicPublishRejectedBatchError(errMsgIdDuplicate))
		...
		//	require_NoError(t, err)
		//	msgId := rsm.Header.Get("Nats-Msg-Id")
		//	if seq == 1 {
		//		require_Equal(t, msgId, "pre-existing")
		//	} else if seq == 2 {
		//		require_Equal(t, msgId, "msgId1")
		//	} else {
		//		require_Equal(t, msgId, "msgId2")
		//	}
		//}
	}
