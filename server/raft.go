...
// LastHeardFromFollower returns when we last heard from the given peer.
// Zero if we never heard from it. The upper layer uses this to judge if
// a meta-assigned peer is up before adding it.
