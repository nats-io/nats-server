...
func TestJetStreamConsumerResetToStartingSequence(t *testing.T) {
	test := func(replicas int) {
		...
		require_NoError(t, err)
		require_Equal(t, msg.Header.Get("Status"), "400")
		require_Equal(t, msg.Header.Get("Description"), "Bad Request - Zero Seq")
