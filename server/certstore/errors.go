...
var (
	...
	// ErrBadCertSkipInvalidField represents malformed cert_skip_invalid option
	ErrBadCertSkipInvalidField = errors.New("expected 'cert_skip_invalid' to be a boolean")
