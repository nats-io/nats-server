...
func TestProtoSnippet(t *testing.T) {
	...
	tests := []struct {
		...
		{input: 2, expected: `"cdefghijklmnopqrstuvwxyzABCDEFGH"`},
		{input: 3, expected: `"defghijklmnopqrstuvwxyzABCDEFGHI"`},
		{input: 4, expected: `"efghijklmnopqrstuvwxyzABCDEFGHIJ"`},
		{input: 5, expected: `"fghijklmnopqrstuvwxyzABCDEFGHIJK"`},
		{input: 6, expected: `"ghijklmnopqrstuvwxyzABCDEFGHIJKL"`},
		{input: 7, expected: `"hijklmnopqrstuvwxyzABCDEFGHIJKLM"`},
		{input: 8, expected: `"ijklmnopqrstuvwxyzABCDEFGHIJKLMN"`},
		{input: 9, expected: `"jklmnopqrstuvwxyzABCDEFGHIJKLMNO"`},
		{input: 10, expected: `"klmnopqrstuvwxyzABCDEFGHIJKLMNOP"`},
		{input: 11, expected: `"lmnopqrstuvwxyzABCDEFGHIJKLMNOPQ"`},
		{input: 12, expected: `"mnopqrstuvwxyzABCDEFGHIJKLMNOPQR"`},
		{input: 13, expected: `"nopqrstuvwxyzABCDEFGHIJKLMNOPQRS"`},
		{input: 14, expected: `"opqrstuvwxyzABCDEFGHIJKLMNOPQRST"`},
		{input: 15, expected: `"pqrstuvwxyzABCDEFGHIJKLMNOPQRSTU"`},
		{input: 16, expected: `"qrstuvwxyzABCDEFGHIJKLMNOPQRSTUV"`},
		{input: 17, expected: `"rstuvwxyzABCDEFGHIJKLMNOPQRSTUVW"`},
		{input: 18, expected: `"stuvwxyzABCDEFGHIJKLMNOPQRSTUVWX"`},
		{input: 19, expected: `"tuvwxyzABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 20, expected: `"uvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"`},
		{input: 21, expected: `"vwxyzABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 22, expected: `"wxyzABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 23, expected: `"xyzABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 24, expected: `"yzABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 25, expected: `"zABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 26, expected: `"ABCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 27, expected: `"BCDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 28, expected: `"CDEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 29, expected: `"DEFGHIJKLMNOPQRSTUVWXY"`},
		{input: 30, expected: `"EFGHIJKLMNOPQRSTUVWXY"`},
		{input: 31, expected: `"FGHIJKLMNOPQRSTUVWXY"`},
		{input: 32, expected: `"GHIJKLMNOPQRSTUVWXY"`},
		{input: 33, expected: `"HIJKLMNOPQRSTUVWXY"`},
		{input: 34, expected: `"IJKLMNOPQRSTUVWXY"`},
		{input: 35, expected: `"JKLMNOPQRSTUVWXY"`},
		{input: 36, expected: `"KLMNOPQRSTUVWXY"`},
		{input: 37, expected: `"LMNOPQRSTUVWXY"`},
		{input: 38, expected: `"MNOPQRSTUVWXY"`},
		{input: 39, expected: `"NOPQRSTUVWXY"`},
		{input: 40, expected: `"OPQRSTUVWXY"`},
		{input: 41, expected: `"PQRSTUVWXY"`},
		{input: 42, expected: `"QRSTUVWXY"`},
		{input: 43, expected: `"RSTUVWXY"`},
		{input: 44, expected: `"STUVWXY"`},
		{input: 45, expected: `"TUVWXY"`},
		{input: 46, expected: `"UVWXY"`},
		{input: 47, expected: `"VWXY"`},
		{input: 48, expected: `"WXY"`},
		{input: 49, expected: `"XY"`},
		{input: 50, expected: `"Y"`},
		{input: 51, expected: `""`},
		{input: 52, expected: `""`},
		{input: 53, expected: `""`},
...
func TestMaxControlLine(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "client", kind: CLIENT, shouldFail: true},
		{name: "leaf", kind: LEAF, shouldFail: false},
		{name: "route", kind: ROUTER, shouldFail: false},
		{name: "gateway", kind: GATEWAY, shouldFail: false},
	} {
