...
func (mb *msgBlock) rebuildStateLocked() (*LostStreamData, []uint64, error) {
	...
	if buf, err = mb.encryptOrDecryptIfNeeded(buf); err != nil {
		return nil, nil, err
	}
	// Check for compression.
	if buf, err = mb.decompressIfNeeded(buf); err != nil {
...
func (mb *msgBlock) recompressOnDiskIfNeeded() error {
	...
	if origBuf, err = mb.encryptOrDecryptIfNeeded(origBuf); err != nil {
		return err
	}
	...
	if cmpBuf, err = mb.encryptOrDecryptIfNeeded(cmpBuf); err != nil {
...
// Lock should be held.
func (mb *msgBlock) encryptOrDecryptIfNeeded(buf []byte) (_ []byte, err error) {
