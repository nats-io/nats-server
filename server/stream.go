...
// numPublicConsumers returns the number of consumers that are not direct/sourcing consumers.
// However, sourcing consumers (that aren't direct) still are deemed "public". These aren't
// counted here since this number is used for limits like MaxConsumers or for WQ exclusivity.
