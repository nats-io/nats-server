...
func TestDNSAltNameMatching(t *testing.T) {
	for idx, test := range []struct {
		...
		{altName: "foo", urls: []string{"FOO"}, match: true},
		{altName: "foo", urls: []string{".."}, match: false},
		{altName: "foo", urls: []string{"."}, match: false},
		{altName: "Foo", urls: []string{"foO"}, match: true},
		{altName: "FOO", urls: []string{"foo"}, match: true},
		{altName: "foo1", urls: []string{"bar"}, match: false},
		{altName: "multi", urls: []string{"m", "mu", "mul", "multi"}, match: true},
		{altName: "multi", urls: []string{"multi", "m", "mu", "mul"}, match: true},
		{altName: "foo.bar", urls: []string{"foo", "foo.bar.bar", "foo.baz"}, match: false},
		{altName: "foo.Bar", urls: []string{"foo", "bar.foo", "Foo.Bar"}, match: true},
		{altName: "foo.*", urls: []string{"foo", "bar.foo", "Foo.Bar"}, match: false}, // only match left most
		{altName: "f*.bar", urls: []string{"foo", "bar.foo", "Foo.Bar"}, match: false},
		{altName: "*.bar", urls: []string{"foo.bar"}, match: true},
		{altName: "*", urls: []string{"baz.bar", "bar", "z.y"}, match: true},
		{altName: "*", urls: []string{"bar"}, match: true},
		{altName: "*", urls: []string{"."}, match: false},
		{altName: "*", urls: []string{""}, match: true},
		{altName: "*", urls: []string{"*"}, match: true},
		{altName: "bar.*", urls: []string{"bar.*"}, match: true},
		{altName: "*.Y-X-red-mgmt.default.svc", urls: []string{"A.Y-X-red-mgmt.default.svc"}, match: true},
		{altName: "*.Y-X-green-mgmt.default.svc", urls: []string{"A.Y-X-green-mgmt.default.svc"}, match: true},
		{altName: "*.Y-X-blue-mgmt.default.svc", urls: []string{"A.Y-X-blue-mgmt.default.svc"}, match: true},
		{altName: "Y-X-red-mgmt", urls: []string{"Y-X-red-mgmt"}, match: true},
		{altName: "Y-X-red-mgmt", urls: []string{"X-X-red-mgmt"}, match: false},
		{altName: "Y-X-red-mgmt", urls: []string{"Y-X-green-mgmt"}, match: false},
		{altName: "Y-X-red-mgmt", urls: []string{"Y"}, match: false},
		{altName: "Y-X-red-mgmt", urls: []string{"Y-X"}, match: false},
		{altName: "Y-X-red-mgmt", urls: []string{"Y-X-red"}, match: false},
		{altName: "Y-X-red-mgmt", urls: []string{"X-red-mgmt"}, match: false},
		{altName: "Y-X-green-mgmt", urls: []string{"Y-X-green-mgmt"}, match: true},
		{altName: "Y-X-blue-mgmt", urls: []string{"Y-X-blue-mgmt"}, match: true},
		{altName: "connect.Y.local", urls: []string{"connect.Y.local"}, match: true},
		{altName: "connect.Y.local", urls: []string{".Y.local"}, match: false},
		{altName: "connect.Y.local", urls: []string{"..local"}, match: false},
		{altName: "gcp.Y.local", urls: []string{"gcp.Y.local"}, match: true},
		{altName: "uswest1.gcp.Y.local", urls: []string{"uswest1.gcp.Y.local"}, match: true},
	} {
...
func TestNoAuthUser(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "user used without pwd", usrInfo: "bar@", ok: false, account: _EMPTY_}, // will be treated as a token
		{name: "user with empty password", usrInfo: "bar:@", ok: false, account: _EMPTY_},
		{name: "no user", usrInfo: _EMPTY_, ok: true, account: "FOO"},
	} {
