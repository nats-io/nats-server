...
const (
	...
	JSConsumerOfflineReasonErrF ErrorIdentifier = 10194
	...
	JSStreamOfflineReasonErrF ErrorIdentifier = 10193
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerOfflineReasonErrF:                {Code: 500, ErrCode: 10194, Description: "consumer is offline: {err}"},
		...
		JSStreamOfflineReasonErrF:                  {Code: 500, ErrCode: 10193, Description: "stream is offline: {err}"},
