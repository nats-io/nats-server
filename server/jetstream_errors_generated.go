...
const (
	...
	JSConsumerPinnedTTLWithoutPriorityPolicyNone ErrorIdentifier = 10194

	// JSConsumerPriorityGroupWithPolicyNone consumer can not have priority groups when policy is none
	JSConsumerPriorityGroupWithPolicyNone ErrorIdentifier = 10193
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerPinnedTTLWithoutPriorityPolicyNone: {Code: 400, ErrCode: 10194, Description: "PinnedTTL cannot be set when PriorityPolicy is none"},
		JSConsumerPriorityGroupWithPolicyNone:        {Code: 400, ErrCode: 10193, Description: "consumer can not have priority groups when policy is none"},
