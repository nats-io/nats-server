...
const (
	...
	// JSSourceNumberOfFiltersAndTransformDestinationMustMatch source must have a matching number of filters and transform destinations
	JSSourceNumberOfFiltersAndTransformDestinationMustMatch ErrorIdentifier = 10144
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSSourceNumberOfFiltersAndTransformDestinationMustMatch: {Code: 400, ErrCode: 10144, Description: "source must have a matching number of filters and transform destinations"},
...
// NewJSSourceNumberOfFiltersAndTransformDestinationMustMatchError creates a new JSSourceNumberOfFiltersAndTransformDestinationMustMatch error: "source must have a matching number of filters and transform destinations"
func NewJSSourceNumberOfFiltersAndTransformDestinationMustMatchError(opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	return ApiErrors[JSSourceNumberOfFiltersAndTransformDestinationMustMatch]
}
