...
const (
	...
	JSMirrorConsumerRequiresAckFCErr ErrorIdentifier = 10211
	...
	JSMirrorDurableConsumerCfgInvalid ErrorIdentifier = 10210
	...
	JSSourceConsumerRequiresAckFCErr ErrorIdentifier = 10214
	...
	JSSourceDurableConsumerCfgInvalid ErrorIdentifier = 10212

	// JSSourceDurableConsumerDuplicateDetected duplicate stream source consumer detected
	JSSourceDurableConsumerDuplicateDetected ErrorIdentifier = 10213
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerAckFCRequiresFCErr:                 {Code: 400, ErrCode: 10216, Description: "flow control ack policy requires flow control"},
		JSConsumerAckFCRequiresMaxAckPendingErr:      {Code: 400, ErrCode: 10217, Description: "flow control ack policy requires max ack pending"},
		JSConsumerAckFCRequiresNoAckWaitErr:          {Code: 400, ErrCode: 10218, Description: "flow control ack policy requires unset ack wait"},
		JSConsumerAckFCRequiresNoMaxDeliverErr:       {Code: 400, ErrCode: 10219, Description: "flow control ack policy requires unset max deliver"},
		JSConsumerAckFCRequiresPushErr:               {Code: 400, ErrCode: 10215, Description: "flow control ack policy requires a push based consumer"},
		...
		JSMirrorConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10211, Description: "stream mirror consumer requires flow control ack policy"},
		JSMirrorConsumerSetupFailedErrF:              {Code: 500, ErrCode: 10029, Description: "{err}"},
		JSMirrorDurableConsumerCfgInvalid:            {Code: 400, ErrCode: 10210, Description: "stream mirror consumer config is invalid"},
		...
		JSSourceConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10214, Description: "stream source consumer requires flow control ack policy"},
		...
		JSSourceDurableConsumerCfgInvalid:            {Code: 400, ErrCode: 10212, Description: "stream source consumer config is invalid"},
		JSSourceDurableConsumerDuplicateDetected:     {Code: 400, ErrCode: 10213, Description: "duplicate stream source consumer detected"},
