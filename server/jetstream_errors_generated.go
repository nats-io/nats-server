...
const (
	...
	JSMirrorConsumerRequiresAckFCErr ErrorIdentifier = 10203
	...
	JSSourceConsumerRequiresAckFCErr ErrorIdentifier = 10204
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerAckFCRequiresFCErr:                 {Code: 400, ErrCode: 10206, Description: "flow control ack policy requires flow control"},
		JSConsumerAckFCRequiresMaxAckPendingErr:      {Code: 400, ErrCode: 10207, Description: "flow control ack policy requires max ack pending"},
		JSConsumerAckFCRequiresNoAckWaitErr:          {Code: 400, ErrCode: 10208, Description: "flow control ack policy requires unset ack wait"},
		JSConsumerAckFCRequiresNoMaxDeliverErr:       {Code: 400, ErrCode: 10209, Description: "flow control ack policy requires unset max deliver"},
		JSConsumerAckFCRequiresPushErr:               {Code: 400, ErrCode: 10205, Description: "flow control ack policy requires a push based consumer"},
		...
		JSMirrorConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10203, Description: "stream mirror consumer requires flow control ack policy"},
		...
		JSSourceConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10204, Description: "stream source consumer requires flow control ack policy"},
